...
import {
  CheckIcon
} from "./chunk-UEUNIK4L.js";
import {
  TimesIcon
} from "./chunk-CCFVAI6R.js";
import {
  CSSTransition,
  TransitionGroup_default
} from "./chunk-RJJFMMMT.js";
import "./chunk-HQQDUZ5F.js";
import {
  Button
} from "./chunk-IQ3QDAWB.js";
import "./chunk-FEZPW67O.js";
import {
  IconBase
} from "./chunk-RMQD6B6K.js";
import {
  Ripple
} from "./chunk-TKKKJBR7.js";
import "./chunk-BHT5NPJO.js";
import "./chunk-6PQICRXS.js";
import "./chunk-RWHHGTGZ.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
...
var ExclamationTriangleIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var InfoCircleIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var TimesCircleIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var UIMessage = React6.memo(React6.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (closable !== false) {
      ...
      var icon = _closeIcon || React6.createElement(TimesIcon, buttonIconProps);
      ...
      return React6.createElement("button", buttonProps, _closeIcon2, React6.createElement(Ripple, null));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (props.message) {
      ...
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = React6.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = React6.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = React6.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = React6.createElement(CheckIcon, iconProps);
            break;
        }
      }
      ...
      return content || React6.createElement(React6.Fragment, null, iconContent, React6.createElement("span", summaryProps, summary), React6.createElement("span", detailProps, detail));
    }
    return null;
  };
  ...
  return React6.createElement("div", rootProps, React6.createElement("div", wrapperProps, message, closeIcon));
}));
...
var messageIdx = 0;
var Messages = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React6.useContext(PrimeReactContext);
  var props = MessagesBase.getProps(inProps, context);
  var _React$useState = React6.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  return React6.createElement("div", _extends6({
    ref: elementRef
  }, rootProps), React6.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(message, index) {
    var messageRef = React6.createRef();
    return React6.createElement(CSSTransition, _extends6({
      nodeRef: messageRef,
      key: message._pId
    }, transitionProps), React6.createElement(UIMessage, {
      hostName: "Messages",
      ref: messageRef,
      message,
...
var ProgressBar = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React7.createElement("div", _extends7({
      id: props.id,
      ref: elementRef
    }, rootProps), React7.createElement("div", valueProps, label != null && React7.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React7.createElement("div", _extends7({
      id: props.id,
      ref: elementRef
    }, rootProps), React7.createElement("div", containerProps, React7.createElement("div", valueProps)));
  };
...
var FileUpload = React8.memo(React8.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React8.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React8.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React8.useState([]), _React$useState4 = _slicedToArray2(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React8.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  var _React$useState7 = React8.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React8.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var fileInputRef = React8.useRef(null);
  var messagesRef = React8.useRef(null);
  var contentRef = React8.useRef(null);
  var uploadedFileCount = React8.useRef(0);
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React8.createElement("span", _extends8({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React8.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React8.createElement("input", inputProps);
    ...
    var icon = _icon || React8.createElement(PlusIcon, chooseIconProps);
    ...
    return React8.createElement("span", chooseButtonProps, input, chooseIcon2, label, React8.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React8.createElement("img", _extends8({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React8.createElement("div", fileNameProps, file.name);
    var size = React8.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React8.createElement("div", detailsProps, React8.createElement("div", fileNameProps, " ", file.name), React8.createElement("span", fileSizeProps, formatSize(file.size)), React8.createElement(Badge, {
    ...
    var removeButton = React8.createElement("div", actionsProps, React8.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React8.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React8.createElement(React8.Fragment, null, preview, contentBody, removeButton);
    ...
    return React8.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React8.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React8.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar"),
      __parentMetadata: {
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React8.createElement(UploadIcon, uploadIconProps), _objectSpread3({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React8.createElement(TimesIcon, cancelIconProps), _objectSpread3({}, cancelIconProps), {
        props
      });
      uploadButton = React8.createElement(Button, {
        type: "button",
        label: uploadLabel,
        "aria-hidden": "true",
        icon: uploadIcon2,
      ...
      cancelButton = React8.createElement(Button, {
        type: "button",
        label: cancelLabel,
        "aria-hidden": "true",
        icon: cancelIcon2,
    ...
    var header = React8.createElement("div", buttonbarProps, chooseButton2, uploadButton, cancelButton);
    ...
    return React8.createElement("div", rootProps, header, React8.createElement("div", contentProps, progressBar, React8.createElement(Messages, {
      ref: messagesRef,
      __parentMetadata: {
        parent: metaData
      }
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React8.createElement("span", _extends8({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React8.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React8.createElement("span", labelProps, hasFiles ? props.selectedFileLabel || filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
        iconOnly: chooseOptions.iconOnly
      })
    }, ptm("chooseIcon"));
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React8.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React8.createElement(UploadIcon, chooseIconProps);
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread3({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React8.createElement("input", inputProps);
    var rootProps = mergeProps({
      className: classNames(props.className, cx("root")),
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React8.createElement("div", rootProps, React8.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message"),
      __parentMetadata: {
        parent: metaData
      }
    }), React8.createElement("span", basicButtonProps, chooseIcon2, label, input, React8.createElement(Ripple, null)));
  };
  if (props.mode === "advanced") {
